...
# 1. Estudios previos habían determinado que la 
...
#2. Según estos datos, ¿es igual la proporción
# de autoras en las áreas de oncología y medicina 
#interna?
...
#3. Suponiendo que la diferencia en la proporción 
